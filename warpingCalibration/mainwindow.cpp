    ...
    ui(new Ui::MainWindow)
{
    ...
    //distortedIMG = imread("/home/ccs/Pictures/floor/2021-04-01/floorCalibCam4.png");   //fetch image with floored chessboard
    distortedIMG = imread("/home/ccs/Pictures/corner/2021-03-31/corner1.png");
...
//    waitKey();
    ...
    FileStorage fileH("/home/ccs/Pictures/topViewImages/params/2021-04-06/topView_H_padsize_Cam1.xml", FileStorage::READ);
    fileH["topViewH"] >> H;
    cout << "H: " << H << endl;
    ...
    //Save topView image
    string filename_topImg = "/home/ccs/Pictures/topViewImages/2021-04-06/topViewImgCam1_2.png";
    imwrite(filename_topImg,src_warped);


    // Wrtie topview params to file
//    FileStorage file("/home/ccs/Pictures/topViewImages/params/2021-04-06/topView_H_padsize_Cam4.xml", cv::FileStorage::WRITE);
//    file << "topViewH" << H;
//    //file << "padSize" << paddingSize;
//    file.release();
