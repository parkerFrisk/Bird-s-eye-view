...
using namespace std;
using namespace cv;
void perspectiveHomograpy2(Mat& undistortedIMG, int CHECKERBOARD[], Mat& H)
{
    ...
    if(success)
    {
        ...
        //cornerSubPix(undistortedIMG,corner_pts,Size(11,11), Size(-1,-1),TermCriteria( TermCriteria::EPS+TermCriteria::COUNT, 30, 0.0001 ));
        ...
        H.at<double>(2,2)=1;   //Scale the image
        //cout << "H: " << H << endl;
