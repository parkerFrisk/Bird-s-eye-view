...
def trimMask(mask1, mask2, corner):
    ...
    cv2.imshow('img3', maskOverlap1_2) 
    # cv2.waitKey(0) 
    ...
    maskOverlap1_2 = cv2.line(maskOverlap1_2,lineStartPoint,lineEndpoint,(0,0,255),2)
    mask1 = cv2.line(mask1,lineStartPoint,lineEndpoint,(0,0,255),1)
    mask2 = cv2.line(mask2,lineStartPoint,lineEndpoint ,(0,0,255),1)

    cv2.namedWindow('img4', cv2.WINDOW_KEEPRATIO)
    cv2.imshow('img4',maskOverlap1_2)
    # cv2.imwrite('/home/ccs/Pictures/stitchedImages/fitLine.png', maskOverlap1_2)  
    cv2.imshow('mask1  ',mask1) 
    cv2.imshow('mask2  ',mask2) 
    # cv2.imwrite('/home/ccs/Pictures/stitchedImages/mask1WithLine.png', mask1)
    # cv2.imwrite('/home/ccs/Pictures/stitchedImages/mask2WithLine.png', mask2)
    ...
    # cv2.waitKey(0)
    # cv2.imwrite('/home/ccs/Pictures/stitchedImages/mask1RemovedOverlap.png', mask1)
    # cv2.imwrite('/home/ccs/Pictures/stitchedImages/mask2RemovedOverlap.png', mask2)
